...
import { L as Loader, a as auth, d as db } from "./router-B6YPSv6B.mjs";
import { c as createUserWithEmailAndPassword, u as updateProfile, a as signInWithEmailAndPassword, G as GoogleAuthProvider, b as signInWithPopup } from "../_libs/firebase__auth.mjs";
...
import { C as CircleCheck, P as Phone, M as Mail, L as Lock } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-16 px-6 py-16 lg:grid-cols-2 lg:py-24 relative z-10 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1/5 border-b border-border/50 lg:w-1/4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-center text-muted-foreground font-bold uppercase tracking-wider", children: "or continue with" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1/5 border-b border-border/50 lg:w-1/4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.button, { whileHover: {
          ...
          scale: 0.98
        }, onClick: handleGoogleSignIn, disabled: loading, className: "mt-6 w-full flex justify-center items-center gap-3 rounded-2xl border border-border/50 bg-white px-4 py-3.5 text-sm font-bold text-foreground shadow-sm hover:bg-secondary/50 transition-all disabled:opacity-70 disabled:cursor-not-allowed", children: [
