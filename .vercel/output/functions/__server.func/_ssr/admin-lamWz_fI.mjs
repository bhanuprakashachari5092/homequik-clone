...
import { q as LayoutDashboard, r as ShoppingCart, U as Users, d as Briefcase, s as Package, G as Gift, t as Activity, u as Settings, c as LogOut, g as Search, v as Bell, D as DollarSign, w as SquarePen, b as CircleX, C as CircleCheck, T as Trash2, f as MapPin } from "../_libs/lucide-react.mjs";
...
function AdminDashboard({
  ...
  const exportDealersToCSV = () => {
    ...
    const csvContent = [headers.join(","), ...dealers.map((d) => [d.id, d.name || d.businessName, d.contact || d.ownerName, d.phone, d.email || "", d.city, d.expertise || d.category, d.plan || "", d.amount || "", d.status, d.paymentStatus || "", d.transactionId || ""].map((v) => `"${(v || "").toString().replace(/"/g, '""')}"`).join(","))].join("\n");
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 p-8 overflow-y-auto", children: activeTab === "Dashboard" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: exportDealersToCSV, className: "bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-4 py-2 rounded-xl font-bold transition-colors flex items-center gap-2 shadow-sm", children: "Export CSV" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowAddModal(true), className: "bg-brand hover:bg-brand-dark text-white px-4 py-2 rounded-xl font-bold transition-colors shadow-sm", children: "+ Add New Dealer" })
          ] })
        ] }),
