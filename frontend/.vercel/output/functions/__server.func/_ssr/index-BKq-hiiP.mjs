...
import { u as useLocation, d as db, c as useAuth, b as useCart, L as Loader } from "./router-vjEfc7KF.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { o as onSnapshot, c as collection, aT as serverTimestamp, Y as addDoc } from "../_libs/firebase__firestore.mjs";
import { P as PartnerMarquee } from "./PartnerMarquee-C7SeJ4d8.mjs";
...
import { a as Sparkles, f as ShieldCheck, m as Star, k as Clock, C as CircleCheck, o as ArrowRight, E as ShoppingCart, H as Settings, W as Wrench, P as Phone, I as Award, X, U as User, c as MapPin, q as Calendar, F as FileText } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-28 space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-[2rem] border border-border shadow-md p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4", children: [
            activeTab === "buy" && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {}),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    services.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-slate-50 py-16 border-b border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: services.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        service.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56 w-full overflow-hidden relative group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: service.imageUrl, alt: service.title, className: "w-full h-full object-cover transition-transform duration-500 hover:scale-105", onError: (e) => {
        ...
        } }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56 w-full bg-gradient-to-br from-brand/10 to-brand/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-12 w-12 text-brand/40" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CCTVSurveillanceDetails, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PartnerMarquee, {})
    ] })
  ] });
}
export {
