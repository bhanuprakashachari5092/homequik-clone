...
import { c as useLocation, b as useAuth, L as Loader, d as db } from "./router-BENyWQ3J.mjs";
...
import { h as Sparkles, i as ShieldCheck, c as Star, j as Clock, C as CircleCheck, k as ShoppingCart, l as Settings, W as Wrench, m as Server, b as Search, n as Shield, P as Phone, o as Award, X, p as User, a as MapPin, g as Calendar, F as FileText } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#f0f4f8] min-h-screen pb-32 font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-8 md:py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#1e293b] rounded-[2rem] overflow-hidden mb-8 shadow-xl relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 md:p-12 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8 space-y-12", children: [
                  wholesaleData.map((categoryData, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 last:mb-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: categoryData.sections.map((section, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden shadow-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-800 p-4 border-b border-[#e2e8f0]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "font-extrabold text-white text-lg", children: section.title }) }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-slate-50 border-t border-slate-200 text-right flex justify-between items-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-slate-500", children: "Customer Care / Inquiry: +91 9141052439" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
          ...
          activeTab === "accessories" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6", children: filteredAccessories.map((acc, i) => {
                  const accString = `Accessory: ${acc.name} [${acc.price}]`;
                  const isSelected = selectedItems.includes(accString);
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `border rounded-2xl p-5 flex flex-col items-center text-center hover:shadow-lg transition-all cursor-pointer group ${isSelected ? "border-brand bg-brand/5" : "border-slate-200 bg-white hover:border-brand/30"}`, onClick: () => toggleSelection(accString), children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `w-full py-2.5 rounded-xl text-sm font-bold transition-all ${isSelected ? "bg-brand text-white shadow-md" : "bg-slate-100 text-slate-700 group-hover:bg-brand group-hover:text-white"}`, children: isSelected ? "✓ Added" : "Add to Selection" })
                  ] }, i);
                }) })
              ]
            },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-background pt-20 pb-32", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/partner", className: "bg-amber-100 text-amber-800 border-2 border-amber-200 hover:bg-amber-200 font-bold py-3 px-6 rounded-full shadow-sm transition-all hover:-translate-y-1 block", children: "Become Partner" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          opacity: 0
        }, animate: {
