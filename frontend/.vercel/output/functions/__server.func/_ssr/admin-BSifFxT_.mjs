...
import { d as db } from "./router-D9WOsIFo.mjs";
import { o as onSnapshot, c as collection, u as updateDoc, d as doc, a9 as deleteDoc, Y as addDoc, aT as serverTimestamp } from "../_libs/firebase__firestore.mjs";
...
import { s as LayoutDashboard, t as Users, b as Briefcase, u as Package, G as Gift, v as Activity, j as LogOut, X, w as Menu, l as Search, x as Bell, C as CircleCheck, U as User, D as DollarSign, y as Download, i as CircleX, T as Trash2, c as MapPin, z as SquarePen } from "../_libs/lucide-react.mjs";
...
function AdminDashboard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-slate-50 flex font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col overflow-hidden relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-20 bg-white border-b border-border flex items-center justify-between px-4 md:px-8 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "md:hidden p-2 rounded-full hover:bg-slate-100 transition-colors", onClick: () => setIsMobileNavOpen(!isMobileNavOpen), children: isMobileNavOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6 text-slate-700" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-6 w-6 text-slate-700" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl md:text-2xl font-bold text-foreground", children: activeTab }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 rounded-full bg-brand/20 border border-brand/30 flex items-center justify-center overflow-hidden shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "https://api.dicebear.com/7.x/avataaars/svg?seed=Admin&backgroundColor=f8fafc", alt: "Admin" }) }),
      ...
      isMobileNavOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden absolute top-20 left-0 w-full bg-white border-b border-border z-40 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col p-4 space-y-2", children: [
        [{
          icon: LayoutDashboard,
          label: "Dashboard"
        }, {
          ...
          icon: Activity,
          label: "Analytics"
        }].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
          setActiveTab(item.label);
          setIsMobileNavOpen(false);
        }, className: `w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${activeTab === item.label ? "bg-brand/10 text-brand font-bold" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: `h-5 w-5 ${activeTab === item.label ? "text-brand" : ""}` }),
          item.label
        ] }, item.label)),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-px bg-border my-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onLogout, className: "w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-slate-500 hover:bg-red-50 hover:text-red-600 transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "h-5 w-5" }),
          "Sign Out"
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 p-8 overflow-y-auto", children: activeTab === "Dashboard" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded-2xl border border-border shadow-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black text-slate-800", children: [
              "₹",
              dealers.reduce((acc, d) => acc + (Number(d.amount) || 4999), 0)
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded-2xl border border-border shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-3xl border border-border shadow-sm overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border-collapse min-w-[800px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: bookings.map((booking, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-slate-50 transition-colors cursor-pointer", onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-4 px-6", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold ${booking.status === "Completed" ? "bg-emerald-100 text-emerald-800" : booking.status === "In Progress" ? "bg-brand/20 text-brand" : "bg-amber-100 text-amber-800"}`, children: booking.status }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-4 px-6", onClick: (e) => e.stopPropagation(), children: (() => {
                const isLocked = booking.paymentStatus === "Paid" && booking.paidAt && Date.now() - booking.paidAt > 10 * 60 * 1e3;
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: booking.paymentStatus || "Pending", onChange: (e) => updateBookingPaymentStatus(booking.id, e.target.value), disabled: isLocked, className: `text-sm border rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-brand font-bold ${booking.paymentStatus === "Paid" ? "border-emerald-200 bg-emerald-50 text-emerald-600" : "border-amber-200 bg-amber-50 text-amber-600"} ${isLocked ? "opacity-50 cursor-not-allowed" : ""}`, title: isLocked ? "Payment status locked (10 mins passed since payment)" : "", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Pending", children: "Pending" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Paid", children: "Paid" })
                ] });
              })() }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-4 px-6 text-right whitespace-nowrap", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDeleteBooking(booking.id), className: "p-1.5 bg-red-50 text-red-600 hover:bg-red-100 rounded-lg transition-colors", title: "Delete Booking", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-5 w-5" }) }) })
            ] }, i);
          }) })
        ] }) }) })
      ...
      showCustomerModal && selectedCustomer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl w-full max-w-lg shadow-xl overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-border flex justify-between items-center bg-slate-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl text-slate-800", children: "Customer Details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowCustomerModal(false), className: "text-slate-400 hover:text-red-500 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-6 w-6" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 space-y-4 max-h-[60vh] overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 font-bold uppercase", children: "Booking ID" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-slate-800", children: selectedCustomer.bookingId || selectedCustomer.id })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 font-bold uppercase", children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold ${selectedCustomer.status === "Completed" ? "bg-emerald-100 text-emerald-800" : selectedCustomer.status === "In Progress" ? "bg-brand/20 text-brand" : "bg-amber-100 text-amber-800"}`, children: selectedCustomer.status })
          ] }),
          selectedCustomer.customerAddress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 sm:col-span-2 break-words", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 font-bold uppercase", children: "Customer Address" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-slate-800", children: selectedCustomer.customerAddress })
          ] }),
          Object.keys(selectedCustomer).filter((key) => !["id", "status", "bookingId", "customerAddress"].includes(key) && typeof selectedCustomer[key] !== "object").map((key) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 sm:col-span-2 md:col-span-1 break-words", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 font-bold uppercase", children: key.replace(/([A-Z])/g, " $1").trim() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-slate-800", children: String(selectedCustomer[key]) })
          ] }, key)),
          selectedCustomer.selectedItems && Array.isArray(selectedCustomer.selectedItems) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 sm:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500 font-bold uppercase mb-1", children: "Selected Items" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: selectedCustomer.selectedItems.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-brand/10 text-brand text-xs font-bold px-2.5 py-1 rounded-lg border border-brand/20", children: item }, idx)) })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-border bg-slate-50 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowCustomerModal(false), className: "bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold py-2 px-6 rounded-xl transition-colors", children: "Close" }) })
      ] }) }),
