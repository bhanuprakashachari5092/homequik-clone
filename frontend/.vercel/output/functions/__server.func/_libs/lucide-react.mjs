...
const Apple = createLucideIcon("apple", __iconNode$M);
const __iconNode$L = [
...
const BatteryCharging = createLucideIcon("battery-charging", __iconNode$I);
const __iconNode$H = [
...
const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$x);
const __iconNode$w = [
...
const Laptop = createLucideIcon("laptop", __iconNode$t);
const __iconNode$s = [
  [
    "path",
    {
...
const Paintbrush = createLucideIcon("paintbrush", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
