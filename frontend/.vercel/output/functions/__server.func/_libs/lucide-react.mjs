...
const Armchair = createLucideIcon("armchair", __iconNode$P);
const __iconNode$O = [
...
const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$A);
const __iconNode$z = [
...
const Paintbrush = createLucideIcon("paintbrush", __iconNode$l);
const __iconNode$k = [
  [
    "path",
    {
