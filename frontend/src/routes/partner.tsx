...
export const Route = createFileRoute("/partner")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join India's fastest growing network of CCTV dealers and installers." },
    ],
  }),
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
               ...
               <div className="bg-white rounded-3xl p-8 shadow-sm border border-border/50">
                  ...
                  <ul className="space-y-4">
                     <li className="flex items-start gap-3">
                        ...
                        <div>
                           <span className="font-bold text-slate-800 block">Verified Leads</span>
                           <span className="text-sm text-slate-500">Get genuine customer inquiries in your area.</span>
                        </div>
                     </li>
                     <li className="flex items-start gap-3">
                        <CheckCircle2 className="h-6 w-6 text-brand shrink-0 mt-0.5" />
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
               <div className="mb-8">
                  <h3 className="text-2xl font-bold text-slate-800">Partner Registration</h3>
